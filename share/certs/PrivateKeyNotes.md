...
unlocked to sign the Agetron-Qt.app bundle.
...
allowing somebody to distribute a Agetron-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the Agetron-qt.exe file inside the installer had not been tampered with.
