...
uint256 hashGenesisBlock("0x159e568c45499a2ebd648ccfb4716057bc05b70966531c016e160c1bdab1e6fa");
uint256 hashGenesisScrypt("0x159e568c45499a2ebd648ccfb4716057bc05b70966531c016e160c1bdab1e6fa");
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uAGT
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 3)  
    {
        nSubsidy = 1000000 * COIN; // premine createur coin  (paycoinalt)
    }
	else if(nHeight == 20)  
    {
...
bool CBlock::ConnectBlock(CValidationState &state, CBlockIndex* pindex, CCoinsViewCache &view, bool fJustCheck)
{
    ...
    int64 nBIP16SwitchTime = 1201838400;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x159e568c45499a2ebd648ccfb4716057bc05b70966531c016e160c1bdab1e6fa");
    }
...
void SetGenesisHash() {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("5473krdb0fe5548272017f1a73180b7105cd6a828e07495a67962e0ea1f78deb486d2bc3f4cef65c4f35504e51de98de5c384df7ba1a9d578a4c751a8ga54f5d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512333386;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x259214ce2249a4caabe4e96a0d0ab406167829520913efcc67d691206c0eb338"));
...
unsigned char pchMessageStart[4] = { 0xd2, 0xb6, 0xe1, 0xf5 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AgetronMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AgetronMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("AgetronMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Agetron-miner");
    ...
    try { loop {
        ...
        printf("Running AgetronMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AgetronMiner terminated\n");
        throw;
    }
}
